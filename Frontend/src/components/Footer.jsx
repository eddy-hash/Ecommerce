...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-gray-800 dark:border-gray-700 border-t border-gray-200 dark:border-gray-700 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <h3 className="text-xl font-bold text-brand-600">ShopHub</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-2 max-w-md">
              E-Commerce & Order Management System — connecting customers with trusted traders.
            </p>
          </div>
          <div>
            <h4 className="font-semibold text-gray-900 dark:text-white mb-3">Shop</h4>
            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-300">
              <li><a href="/categories" className="hover:text-brand-600">Categories</a></li>
              <li><a href="/traders" className="hover:text-brand-600">Traders</a></li>
            </ul>
          </div>
          <div>
